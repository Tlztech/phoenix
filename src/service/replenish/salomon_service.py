...
from service.common.salomon_common import sprider
from util import log_util, excel_util, env_util, mail_util, common_utils


def service():
    log_util.info(f"品牌{brand.SALOMON_BRAND}补货检查脚本processing")
    ...
    if not item_codes:
        ...
        log_util.info(f"品牌{brand.SALOMON_BRAND}补货检查脚本processed")
    elif not targets:
        ...
        try:
            ...
            log_util.info(f"品牌{brand.SALOMON_BRAND}价格变动检查脚本processed")